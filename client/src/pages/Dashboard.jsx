...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6 w-full animate-fade-in pb-12">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl p-6 text-white shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4 transition-all hover:shadow-md">
        <div className="text-center sm:text-left">
          <h4 className="font-bold text-lg">Marketplace Inventory Control</h4>
          <p className="text-xs text-purple-100 mt-1">Review active produce listings, configure price thresholds, or fulfill outstanding orders.</p>
        </div>
        <button className="bg-white text-purple-700 hover:bg-purple-50 transition-all font-bold text-xs px-4 py-2.5 rounded-xl flex items-center gap-1.5 active:scale-95 shrink-0 shadow-sm">
